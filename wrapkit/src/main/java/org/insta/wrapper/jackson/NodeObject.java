...
public final class NodeObject {
    ...
    /**
     * Constructor to initialize the NodeObject with the given ObjectNode.
     *
     * @param objectNode The ObjectNode to initialize the NodeObject with.
     */
    public NodeObject(ObjectNode objectNode) {
    ...
    /**
     * <p>
     * Puts a Long value into the object node with the specified key.
     * </p>
     *
     * @param key   The key for the value.
     ...
     * @param value The Long value to put.
     */
    public void putNode(final String key, final Long value) {
        this.objectNode.put(key, value);
    }

    /**
     * Getter for the objectNode.
     *

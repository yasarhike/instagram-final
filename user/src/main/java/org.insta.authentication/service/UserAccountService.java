...
public interface UserAccountService {
     ...
     */
    byte[] getProfile(final Long profileId);
     ...
     */
    byte[] deleteProfile(final Long profileId);

    /**
     * <p>
     * Injects the DAO into the service.
     * </p>
     *
     * @param userAccountDAO {@link UserAccountDAO} Inject the dao into the service.
     */
    void setReplacer(final UserAccountDAO userAccountDAO);
}
